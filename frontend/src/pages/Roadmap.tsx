    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <div>
        ...
        <p className="mt-1 text-ink-500 dark:text-ink-400">
          A personalized 4-week plan to get you ready for your target roles.
        </p>
      </div>
            ...
            <CardContent>
              ...
              <li
                ...
                className="flex items-center gap-3 text-sm text-ink-700 dark:text-ink-300">
                    ...
                    <div
                  className={`h-1.5 w-1.5 rounded-full ${item.status === 'completed' ? 'bg-success' : 'bg-ink-300 dark:bg-ink-600'}`} />
